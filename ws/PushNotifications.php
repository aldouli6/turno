...
class PushNotifications {
	...
	protected $AppBundleId = 'com.velezoft.turnoapp'; //com.yourappname.app
    protected $GoogleAPIKey='AIzaSyBjycI1P7H-mNG1XTb2qpItXOIuTJzhWoU'; // API access key from Google API's Console
    ...
    public function sendAndroidNotifications($to, $message,$data){
        $androidMessage=$this->createAndroidMessage($message);
		$fields=array(	"registration_ids"	=>$to, 
						"notification"		=>$androidMessage,
						"data"				=> $data
					);
		//$fields=array("to"=>$to, "notification"=>$message);
		$headers = array(
