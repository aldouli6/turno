...
*/include_once('../lib/nusoap/nusoap.php');
	...
	$stockprice = $c->call('wsmethod',array('case'=>'listaTipoReporte','value'=>''));
	...
	/*$jason='{"EstatusId":"1","TiporeporteId":"11","ReporteId":"321","ReporteRegistro":"02\/27\/2018 11:27:29 PM"}';
	echo json_decode($jason);*/
	if ($c->fault) {
