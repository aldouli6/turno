                     ...
                     <form role="form" id="formRegistroUsuario" role="form" autocomplete="off">
                      ...
                      <div class="form-group form-group-default input-group">
                            ...
                            <span class="input-group-addon bg-transparent">
                                <div class="lcs_wrap"><input name="StatusUsuario" id="StatusUsuario" class="lcs_check" type="checkbox"><div class="lcs_switch  lcs_checkbox_switch lcs_on"><div class="lcs_cursor"></div></div></div>
                            </span>
          ...
          <div class="panel panel-transparent">
            <div class="panel-body">
               <form role="form" id="formEdicionUsuario" role="form" autocomplete="off">
                ...
                <div class="form-group form-group-default input-group">
                        <div id="divstatus1Edit" style="display: block;"><label class="inline" style="margin-top: 15px; margin-left: 12px" id="StatusColono1Edit" name="StatusColono1Edit">Habilitado</label></div>
                        <div id="divstatus2Edit" style="display: none;"><label class="inline" style="margin-top: 15px; margin-left: 12px" id="StatusColono2Edit" name="StatusColono2Edit">Deshabilitado</label></div>
                        <span class="input-group-addon bg-transparent">
                        <div class="lcs_wrap"><input name="editStatusColono" id="editStatusColono" class="lcs_checkEdit" type="checkbox"><div class="lcs_switch  lcs_checkbox_switch lcs_on"><div class="lcs_cursor"></div></div></div>
                        </span>
